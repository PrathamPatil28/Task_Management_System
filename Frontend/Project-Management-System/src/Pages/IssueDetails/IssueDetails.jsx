...
const IssueDetails = () => {
    ...
    const handleUpdateIssueStatus = (status) => {
        dispatch(updateIssueStatus({ id: issueId, status })); // Ensure correct payload
                        ...
                        <div className='p-5'>
                           <div className='space-y-7'>
                              ...
                              <div className='flex gap-10 items-center'>
                                 ...
                                 {issue.issueDetails?.assignee?.fullName? <div className='flex gap-3 items-center'>
                                    <Avatar className="w-8 h-8 rounded-full bg-gray-600 text-sm ">
                                        <AvatarFallback>
