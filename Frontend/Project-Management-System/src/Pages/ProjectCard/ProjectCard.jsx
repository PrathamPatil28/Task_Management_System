...
import { deleteProjectById, fecthProjectById } from '@/Redux/Project/Action'
...
const ProjectCard = ({item}) => {
    ...
    return ( 
        <div>
                        ...
                        <div className='flex justify-between'>
                            ...
                            <div>
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent >
                                        <DropdownMenuItem onClick={() => setOpenUpdate(true)} className="cursor-pointer">
                                            Update
                                        </DropdownMenuItem>
            ...
            <UpdateProjectModal open={openUpdate} setOpen={setOpenUpdate} project={item} />
        </div>
